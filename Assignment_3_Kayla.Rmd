...
There are 75 rows of data, this represents 75 Metropolitan Statistical Areas (MSA)and there are 8 variables in the columns, 4 of which are . The additional columns are the GEOID, and raw data from which we calculated our Categorical Variables. 

# Assignment 3 

Our dependent variable is the For Sale Housing Inventory of each MSA. My independent variables are median age, population density, county type, and majority vote in the most recent presidential election.
