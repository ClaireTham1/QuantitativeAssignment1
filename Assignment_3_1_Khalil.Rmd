...
# df_filtered <- data %>% filter_at(vars(SaleP_Sep),all_vars(!is.na(.))) #These work too, but are just different functions that work with dplyr 
# df_not_na <- data %>% filter(!is.na(SaleP_Sep))
